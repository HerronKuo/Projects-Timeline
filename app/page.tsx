    ...
    return (
        <div className="container mx-auto max-w-4xl px-4 py-12">
            <div className="text-center mb-12 overflow-visible">
                ...
                <p className="text-xl text-muted-foreground max-w-2xl mx-auto md:whitespace-nowrap">Explore my journey through various projects and their development stories</p>
            </div>
